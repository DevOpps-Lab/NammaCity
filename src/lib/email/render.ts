...
<div style="max-width:600px;margin:0 auto;padding:24px 16px">
  <div style="background:#0f766e;border-radius:12px 12px 0 0;padding:16px 20px">
    ...
    <div style="color:#99f6e4;font-size:12px;margin-top:2px">Citizen-verified civic complaint</div>
  </div>
  <div style="background:#ffffff;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px;padding:22px 20px">
    ...
    <p style="margin:0;color:#94a3b8;font-size:11px;line-height:1.5">
      Sent via CivicAgent · This complaint is tracked publicly and will be marked
      resolved only when a resident confirms the repair with a photograph — not on
      a status update alone.
    </p>
  </div>
</div>
</body></html>`;
